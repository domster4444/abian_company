      ...
      <div className="containerCenter">
        <div className="contentBlock">
          <main className="processPageMain1">
            <section className="leftSection">
              ...
              <p className=" poppins_regular_400">
                Why I say old chap that is spiffing bodge, blag pardon me bugged
                mufty Oxford butty bubble and squeak wind up, brown bread them
                full monty bloke ruddy cras tickety-boo squiffy. Starkers
                dropped a clanger lurgy is cack excuse my French what a plonker
                blower. On Oxford butty bubble and squeak wind up monty bloke
                ruddy cras tickety-boo squiffy.
              </p>
            </section>
            <section className="rightSection">
              <img src={process_image1} alt="illustrator describing process" />
            </section>
          </main>
          <main className="processPageMain2">
            ...
            <section className="rightSection">
              <img src={process_image2} alt="illustrator describing process" />
            </section>
          </main>
          <main className="processPageMain22">
            ...
            <section className="rightSection">
              <img src={process_image3} alt="illustrator describing process" />
            </section>
          </main>
          ...
          <main className="processPageMain2">
            ...
            <section className="rightSection">
              <img src={process_image4} alt="illustrator describing process" />
            </section>
          </main>
          ...
          <main className="processPageMain4">
            ...
            <section className="rightSection">
              <img src={process_image5} alt="illustrator describing process" />
            </section>
          </main>
        </div>
      </div>
